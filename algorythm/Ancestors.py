...
class Ancestors:
    def __init__(self):
        ...
        self.max_sets = 400  # maxymalna ilosc samochodo ktore przechodza dalej
        self.base_unfollow_probability = 0.1  # zmienna na bazowe prawdopodobieństow zejscia ze sciezki
    ...
    def next_step(self, cars):
        ...
        for car in cars:
            if car.collide:
                ...
                car.jump = 0.1  # zad11 zmiana prawdopodobienstwa w kazdym kroku
                cars_new.append(car)
        return cars_new
    ...
    def who_to_follow(self, cars):
        ...
        for car in cars:
            ...
            # car.follow_path = [0]
            car.jump = 0.1 # zad11 początkowe prawdopodobienstwo zejscia ze sciezki
