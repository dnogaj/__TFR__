...
class MainMenu:
    ...
    def __init__(self):
        ...
        self.zlom = pygame.transform.scale(pygame.image.load('images/zygzzlom.jpg'), (self.WIDTH, self.HEIGHT))
        self.menu_command = 0
    ...
    def draw_game(self):
        ...
        menu_btn = Button('Main Menu', (self.WIDTH/2 - 75, self.HEIGHT - 100), self.screen, self.font)
        menu_btn.draw()
    ...
    def draw_options(self):
        """draw_options -> creates option screen, which you can open by clicking at the 'options' button at the main_menu screen"""
            ...
            if self.main_menu:
                ...
                if self.menu_command > 0:
                    ...
                    if self.menu_command == 2:
                        ...
                        pygame.display.flip()
                        self.text = self.font.render("Choosen Game Option  ->  " + str(self.option_command),
                                                     True, 'black')
